...
echo $OUTPUT->heading(get_string('boardzadmin', 'local_boardz_admin'), 1);

$config = get_config('local_boardz_admin');
if (empty($config->baseurl)) {
    echo $OUTPUT->notification(get_string('unconfigured', 'local_boardz_admin'));
} else {
    echo $renderer->main_menu();
}
