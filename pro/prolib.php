...
define('LOCAL_BOARDZ_ADMIN_COMPONENT_PROVIDER_ROUTER_URL', 'http://www.mylearningfactory.com/providers/router.php');

final class pro_manager {

    private static $component = 'local_boardz_admin';
    private static $componentpath = 'local/boardz_admin';
    ...
    public static function send_empty_license_signal() {
        ...
        if (local_boardz_admin_supports_feature() && empty($config->licensekey)) {
            if ($config->licensekeycheckdate < time() - 30 * DAYSECS) {

                $url = LOCAL_BOARDZ_ADMIN_COMPONENT_PROVIDER_ROUTER_URL;
    ...
    public static function print_empty_license_message() {
        return '<div class="licensing">-- Pro licensed version --<br/>This plugin is being used in pro version without license key for demonstration. It will have limitations.</div>';
    }
